...
//  Favorite Cities
//
//  Created by Lauren Carder on 1/29/19.
...
class MasterViewController: UITableViewController {
    ...
    func insertNewObject(_ sender: Any) {
       let alert = UIAlertController(title: "Add City", message: nil, preferredStyle: .alert)
        alert.addTextField{
            (textField) in textField.placeholder = "City"
        }
        alert.addTextField{
            (textField) in textField.placeholder = "State"
        }
        alert.addTextField{
            (textField) in textField.placeholder = "Population"
        ...
        present(alert, animmated: true, completion: nil)
    }
    // MARK: - Segues
